...
https://github.com/smartiniOnGitHub/grails-angularjs-resources/issues?state=open
...
- future:
	...
	- migrate from Resources Plugin to Asset-Pipeline Plugin (default in Grails-2.4.x) ...
