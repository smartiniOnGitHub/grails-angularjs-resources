...
- for release 1.4.1 (update dependencies) ... ok
	...
	- AngularJsAjaxFilters, in test webapp 2.4 add a sample ajax call to sample Grails Controller or the Rest-like one (update related view accordingly) ... 
	- Rest sample Controller, in test webapp 2.4, add an ajaxData action, and there return a list of results (more than 1 record), for a more general sample ...
